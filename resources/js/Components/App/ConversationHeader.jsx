                    ...
                    {selectedConversation.is_group && (
                        <div className=" flex gap-3">
                            ...
                            {selectedConversation.owner_id == authUser.id && (
                                <>
                                    <div className=" tooltip tooltip-left before:content-[attr(data-tip)]" data-tip="Edit Group">
                                        <button onClick={(ev) => emit("GroupModal.show", selectedConversation)} className=" text-gray-400 hover:text-gray-200">
                                            <PencilSquareIcon className=" w-4" />
                                        </button>
                                    </div>
                                    <div className=" tooltip tooltip-left before:content-[attr(data-tip)]" data-tip="Delete Group">
